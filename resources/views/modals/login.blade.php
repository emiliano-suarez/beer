...
<div class="modal fade" id="modalLogin" tabindex="-1" role="dialog" aria-labelledby="modalLogin" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="loginmodal-container">
            ...
            <div scope="{{ implode(',',config('social.facebook_scope')) }}" onlogin="checkLoginState();" class="fb-login-button" data-max-rows="1" data-size="xlarge" data-show-faces="false" data-auto-logout-link="false"></div>
...
-->
            ...
            <div class="login-help">
                <a href="{{ url('/register') }}">Registrarme</a> - <a id="btnForgotPassword" href="#">No se mi clave</a>
            </div>
        </div>
    </div>
</div>
